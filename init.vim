...
Plug 'https://github.com/goolord/alpha-nvim' " For the vim startup 
Plug 'kyazdani42/nvim-web-devicons' " for the vim startup 
Plug 'https://github.com/mhinz/vim-signify' " to signify minor git updates 
Plug 'dracula/vim', { 'as': 'dracula' } " dracula theme for nvim 
Plug 'glepnir/dashboard-nvim'  " dashboard for nvim
Plug 'liuchengxu/vim-clap'  " vim clap for dashboard 
Plug 'junegunn/fzf', { 'do': { -> fzf#install() } } " fuzzy finder for dashboard
Plug 'nvim-lua/plenary.nvim' " dependency for telescope 
Plug 'nvim-telescope/telescope.nvim' " telescope for dashboard
...
let g:which_key_map['t'] = [ ':TerminalSplit bash'                       , 'terminal' ]
